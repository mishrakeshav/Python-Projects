...
if __name__ == '__main__':
    ...
    button1 = Button(root, text=' 1 ', fg='black', bg='wheat2',
                     command=lambda: press(1), height=h, width=w, font=("arial", 10, "bold"))
    button1.grid(row=2, column=0)

    button2 = Button(root, text=' 2 ', fg='black', bg='wheat2',
                     command=lambda: press(2), height=h, width=w, font=("arial", 10, "bold"))
    button2.grid(row=2, column=1)

    button3 = Button(root, text=' 3 ', fg='black', bg='wheat2',
                     command=lambda: press(3), height=h, width=w, font=("arial", 10, "bold"))
    button3.grid(row=2, column=2)

    button4 = Button(root, text=' 4 ', fg='black', bg='wheat2',
                     command=lambda: press(4), height=h, width=w, font=("arial", 10, "bold"))
    button4.grid(row=3, column=0)

    button5 = Button(root, text=' 5 ', fg='black', bg='wheat2',
                     command=lambda: press(5), height=h, width=w, font=("arial", 10, "bold"))
    button5.grid(row=3, column=1)

    button6 = Button(root, text=' 6 ', fg='black', bg='wheat2',
                     command=lambda: press(6), height=h, width=w, font=("arial", 10, "bold"))
    button6.grid(row=3, column=2)

    button7 = Button(root, text=' 7 ', fg='black', bg='wheat2',
                     command=lambda: press(7), height=h, width=w, font=("arial", 10, "bold"))
    button7.grid(row=4, column=0)

    button8 = Button(root, text=' 8 ', fg='black', bg='wheat2',
                     command=lambda: press(8), height=h, width=w, font=("arial", 10, "bold"))
    button8.grid(row=4, column=1)

    button9 = Button(root, text=' 9 ', fg='black', bg='wheat2',
                     command=lambda: press(9), height=h, width=w, font=("arial", 10, "bold"))
    button9.grid(row=4, column=2)

    button0 = Button(root, text=' 0 ', fg='black', bg='wheat2',
                     command=lambda: press(0), height=h, width=w, font=("arial", 10, "bold"))
    button0.grid(row=5, column=0)
    plus = Button(root, text=' + ', fg='black', bg='wheat2',
                  command=lambda: press("+"), height=h, width=w, font=("arial", 10, "bold"))
    ...
    equal = Button(root, text=' = ', fg='black', bg='wheat2',
                   command=equalpress, height=h, width=w, font=("arial", 10, "bold"))
    equal.grid(row=5, column=2)

    clear = Button(root, text='Clear', fg='black', bg='wheat2',
                   command=clear, height=h, width=w, font=("arial", 10, "bold"))
